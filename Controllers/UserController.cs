...
namespace HelpDeskProject.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            //Include tells entity to grab related objects from the database
            //There are man posts for one blog, so we need to include those posts
            return View(await _context.Blogs.Include(y => y.Posts).ToListAsync());
        }
